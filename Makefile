...
image:
	time sudo ubuntu-image classic --debug -w result -u perform_manual_customization tinyos.yaml
	...
	time sudo ubuntu-image classic --debug -w result -r -t perform_manual_customization tinyos.yaml
